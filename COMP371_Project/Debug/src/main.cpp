...
int main()
{
	...
	Shader * defaultShader = new Shader("/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/vertex.shader", "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/default.shader");
	Shader * cityTileShader = new Shader("/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/vertex.shader", "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/cityTile.shader");
	Shader * rockTileShader = new Shader("/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/vertex.shader", "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/rockTile.shader");
    Shader skyboxShader( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/sbvtx.shader", "/Users/nicholasfong/Documents/COMP371Final/COMP371Final/sbfr.shader" );
	...
	* Pls use the order from the tile.h const declarations*/
    ...
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_rt.tga" );
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_lf.tga" );
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_up.tga" );
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_dn.tga" );
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_bk.tga" );
    faces.push_back( "/Users/nicholasfong/Downloads/Comp371-keven/COMP371_Project/src/skybox/desert_night_ft.tga" );
	...
	int width, height;
	unsigned char* image = SOIL_load_image("/Users/nicholasfong/Documents/COMP371Final/COMP371Final/buildings.jpg", &width, &height, 0, SOIL_LOAD_RGB);
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	// Load, create texture and generate mipmaps
	image = SOIL_load_image("/Users/nicholasfong/Documents/COMP371Final/COMP371Final/snow.jpeg", &width, &height, 0, SOIL_LOAD_RGB);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, image);
	glGenerateMipmap(GL_TEXTURE_2D);
	SOIL_free_image_data(image);
		...
		for (GLuint i = 0; i < tiles->size() ; i++)
		{
			for (GLuint j = 0; j < (*tiles)[i].size(); j++)
			{
				...
				***** create complex shaders\
                 *******/
                glBindTexture(GL_TRIANGLE_STRIP, texture1);
